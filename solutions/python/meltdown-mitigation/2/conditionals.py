...
def reactor_efficiency(voltage, current, theoretical_max_power): #Assess reactor efficiency zone
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):#Assess and return status code for the reactor.
